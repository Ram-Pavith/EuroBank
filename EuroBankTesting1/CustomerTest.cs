...
//namespace EuroBankTesting1
//{
//    [TestFixture]
//    public class CustomerTest
//    {
//        private Mock<IUnitOfWork> _context;
//        private Mock<ICustomerRepository> cusRepo;
//        private Mock<Logger<CustomerController>> _logger;
...
//        };
//        private List<Customer> customeracc = new List<Customer>()
//        {
//            new Customer
//            {
//                CustomerId="CustomerEurobank",
...
//            cusRepo = new Mock<ICustomerRepository>();
//            _mapper = new Mock<IMapper>();
//            _customerController = new CustomerController(_context.Object,_logger.Object, _mapper.Object,_authService.Object);

//        }
//        [TestCase("CustomerEurobank")]
//        public void getCustomerAccounts()
//        //{
//        //    Task<IEnumerable<Customer>> customers = Task.FromResult(customeracc.AsEnumerable());
//        //    _context.Setup(p=>p.Customers.GetAllAsync(null,null)).Returns(customers);
//        //    var result = _customerController.getCustomerAccounts(string CustomerId);
//        }
